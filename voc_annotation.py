...
#   默认指向根目录下的VOC数据集
#-------------------------------------------------------#
VOCdevkit_path      = '/mnt/data1_hdd/wgk/tr-naturecommucation/unet-pytorch-region/VOCdevkit'

if __name__ == "__main__":
    random.seed(0)
    print("Generate txt in ImageSets.")
    segfilepath     = os.path.join(VOCdevkit_path, 'VOC2007/SegmentationClass')
    saveBasePath    = os.path.join(VOCdevkit_path, '/mnt/data1_hdd/wgk/tr-naturecommucation/unet-pytorch-region/VOCdevkit/VOCC')
